...
上课讲的是基础的 C++ 语法，但是课程作业是不知什么难度的 OI 题。作业内容严重超前于课程内容，须要自学。

期中后的课程有课上练习，非常简单，不做可能会影响成绩（不清楚）

期中期末考试的简单题（比作业简单很多）占据了大量分值，只要掌握了作业内容就没问题。

该课程被要求“给分不需要区分度”，因此给分都很高（往年应该也差不多）
