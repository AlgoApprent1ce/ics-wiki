...
平常上课大家都听不懂，教材适合期末复习而不是第一次接触该内容的时候看。建议自学（一曝十寒）。

#### 考核情况：
平时作业10%+期中考试30%+期末考试60%
考试范围是1，3，4，6，7，10，11章节，MP不考使得复习量与难度大大减轻。

笔者认为主要考察的数理逻辑方法是 1.证明树 2.紧性定理 3.语义证明 实际上写明白证明树就能够应付绝大多数题目了。

考前复习1-2天足够，记得把往年卷+作业题及其答案打印完全，对着抄即可。有80分原题能够在往年卷及课后作业题中找到。

唯一有难度的是最后一题考察的是upper Löwenheim skolem theorem的证明（10分）

#### 给分情况：

作业只要提交了就是满分。期中期末成绩均可以在助教处查到。最后会四舍五入到整数。建议期中作业和其他同学核对一下答案再提交。由于原题实在是太多了，总评给分良好。
