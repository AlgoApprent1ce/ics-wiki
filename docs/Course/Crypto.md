...
注：上课时主要使用PPT进行授课，但作业均出自于英文版教材（但是教材答案只有第二版的，部分题目可能没有答案）。
...
**期末考试**：23级为开卷考试，资料不限，有作业原题。往年试卷请见NJU BOX。
...
教材改为 **Introduction To Modern Cryptography(3rd Edition)** by Jonathan Katz and Yehuda Lindell，课程所用 PPT 相较往年基本没有变动。

期末总评 = 60% 作业 + 10% 期中 + 30% 期末。

作业 giveup 没有分。期中期末均为开卷考试，均有一道简答（实际是抄课本）题和若干道综合性大题。笔者觉得期中较难，期末较简单，建议熟练掌握往年卷和作业题目。
